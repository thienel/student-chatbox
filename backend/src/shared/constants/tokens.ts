export const TOKENS = {
  ...
  STUDY_REPO: 'STUDY_REPOSITORY',
  WEAK_TOPIC_REPO: 'WEAK_TOPIC_REPOSITORY',
  STUDY_PLAN_REPO: 'STUDY_PLAN_REPOSITORY',
  BADGE_REPO: 'BADGE_REPOSITORY',
  BOARD_REPO: 'BOARD_REPOSITORY',
  OTP_TOKEN_REPO: 'OTP_TOKEN_REPOSITORY',
} as const;
